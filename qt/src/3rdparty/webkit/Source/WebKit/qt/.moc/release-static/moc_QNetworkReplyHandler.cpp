...
**
** Created: Mon Jul 1 18:33:14 2013
...
static const char qt_meta_stringdata_WebCore__QNetworkReplyHandlerCallQueue[] = {
...
const QMetaObjectExtraData WebCore::QNetworkReplyHandlerCallQueue::staticMetaObjectExtraData = {
    0,  qt_static_metacall 
};

const QMetaObject WebCore::QNetworkReplyHandlerCallQueue::staticMetaObject = {
    { &QObject::staticMetaObject, qt_meta_stringdata_WebCore__QNetworkReplyHandlerCallQueue,
      qt_meta_data_WebCore__QNetworkReplyHandlerCallQueue, &staticMetaObjectExtraData }
};

#ifdef Q_NO_DATA_RELOCATION
const QMetaObject &WebCore::QNetworkReplyHandlerCallQueue::getStaticMetaObject() { return staticMetaObject; }
...
{
    if (!_clname) return 0;
    if (!strcmp(_clname, qt_meta_stringdata_WebCore__QNetworkReplyHandlerCallQueue))
